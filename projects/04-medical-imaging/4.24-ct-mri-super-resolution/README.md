...
ESRGAN (enhanced SRGAN), 3D U-Net SR, CycleGAN for unpaired SR, diffusion model SR (SR3, DDPM), subpixel convolution (ICNR), attention U-Net SR, learned upsampling (LIIF), perceptual and adversarial losses, self-supervised SR.
...
cuDNN (3D transposed convolutions, pixel shuffle); Tensor Cores for FP16 SR training; gradient penalty in discriminator (cuBLAS); CuPy for efficient patch extraction; TensorRT for INT8/FP16 inference deployment. --
