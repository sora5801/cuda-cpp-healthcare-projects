...
# ---------------------------------------------------------------------------
# Project 4.29 : Light-Sheet Microscopy Reconstruction (cuFFT Richardson-Lucy)
#
...
$Slug        = "light-sheet-microscopy-reconstruction"
$Sln         = Join-Path $ProjectRoot "build\$Slug.sln"
$Exe         = Join-Path $ProjectRoot "build\x64\Release\$Slug.exe"
$Sample      = Join-Path $ProjectRoot "data\sample\lsfm_sample.txt"
