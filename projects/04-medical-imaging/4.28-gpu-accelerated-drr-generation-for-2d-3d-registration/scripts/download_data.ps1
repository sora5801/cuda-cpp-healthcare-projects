...
Write-Host "    Gold Atlas prostate CT (https://www.goldenatlasproject.com/ — verify URL); TCIA prostate/lung CTs; AAPM TG-132 test cases; clinical CBCT + kV images (institutional IRB)."
Write-Host ""
