...
# ---------------------------------------------------------------------------
# Project 2.2 -- Protein-Protein Docking  (FFT rigid-body docking via cuFFT)
#
