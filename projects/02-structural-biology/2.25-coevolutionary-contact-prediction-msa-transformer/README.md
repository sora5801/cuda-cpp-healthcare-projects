...
Mutual information (MI), Direct Coupling Analysis (DCA), pseudolikelihood-maximized DCA (PLMC), message-passing DCA (mpDCA), MSA Transformer (axial row/column attention), coevolutionary coupling score to contact map.
