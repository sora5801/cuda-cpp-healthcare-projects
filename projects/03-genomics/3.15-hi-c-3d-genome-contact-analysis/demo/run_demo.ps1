...
#   stdout (deterministic biases / insulation / TAD boundaries) is diffed
#   against expected_output.txt; stderr (timing) is shown but not diffed.
# ===========================================================================
...
$Sample      = Join-Path $ProjectRoot "data\sample\hic_sample.txt"
