...
// ---------------------------------------------------------------------------
// Project 10.6 -- Wearable & Continuous-Sensor Signal Processing   (template skeleton)
//
...
static const char* PROJECT_ID   = "10.6";
static const char* PROJECT_NAME = "Wearable & Continuous-Sensor Signal Processing";
