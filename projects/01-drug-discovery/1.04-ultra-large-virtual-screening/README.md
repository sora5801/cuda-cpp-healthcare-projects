...
GPU-batched LGA/BFGS docking, Bayesian active learning, surrogate-model filtering (random forest, GNN), pharmacophore pre-filtering, shape screening pre-filter, Lipinski/ADMET filter cascades.
...
Texture memory for grid lookups; warp-parallel GA evaluation; multiple ligands co-resident in GPU memory; NVLink multi-GPU for campaign-scale throughput; thrust for top-K selection. --
