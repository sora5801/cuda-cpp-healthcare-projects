...
# ---------------------------------------------------------------------------
# Project 13.4 -- Drug-Drug Interaction Prediction   (template skeleton)
#
...
Write-Host "[download_data] Project 13.4 -- Drug-Drug Interaction Prediction"
