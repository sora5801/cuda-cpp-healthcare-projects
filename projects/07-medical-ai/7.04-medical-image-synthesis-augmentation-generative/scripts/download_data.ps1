...
# ---------------------------------------------------------------------------
# Project 7.4 -- Medical Image Synthesis & Augmentation (Generative)   (template skeleton)
#
...
Write-Host "[download_data] Project 7.4 -- Medical Image Synthesis & Augmentation (Generative)"
